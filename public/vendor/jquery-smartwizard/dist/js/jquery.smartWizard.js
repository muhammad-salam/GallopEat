  ...
  var SmartWizard = /*#__PURE__*/function () {
    ...
    _createClass(SmartWizard, [{
      ...
      value: function _createToolbar(position) {
        ...
        var btnsubmit = this.options.toolbarSettings.showPreviousButton !== false ? $('<button></button>').text(this.options.lang.submit).addClass('btn btn-primary sw-btn-sub').attr({'type':'button','id':'submitbtn'}): null;
        toolbar.append(btnPrevious, btnNext,btnsubmit); // Add extra toolbar buttons

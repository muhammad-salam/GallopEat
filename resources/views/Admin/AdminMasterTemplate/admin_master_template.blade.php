    ...
    <div id="main-wrapper">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
									...
									<div class="header-info">
										<span class="fs-20 font-w500">@isset(session()->get('users')['first_name']) {{ session()->get('users')['first_name'].' '.session()->get('users')['last_name'] }} @endisset</span>
        ...
        ***********************************-->
        <div class="footer">
            ...
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="#" target="_blank">GallopEat</a> 2021</p>
            </div>
        </div>
        <!--**********************************
            Footer end

...
<head>
	...
	<link href="http://gallopeat.com/css/plugin/toastr.min.css" rel="stylesheet">
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
				...
				<div class="brand-title">GallopEat</div>
            </a>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
									...
									<div class="header-info">
										<span class="fs-20 font-w500">{{ session()->get('users')['first_name'].' '.session()->get('users')['last_name'] }}</span>
										<small>Resturant Owner</small>
									</div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="/logout_page" class="dropdown-item ai-icon">
        ...
        ***********************************-->
            <div class="deznav">
                <div class="deznav-scroll">
                    <ul class="metismenu" id="menu">
                    	<li><a class="has-arrow ai-icon" href="javascript:void(0)" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                <li><a href="/show_items">Items</a></li>
                                <li><a href="./ui-alert.html">Add Pricing </a></li>
                               	<li><a href="{{ url('discount') }}">Add Discount</a></li>
                                <li><a href="{{ url('offers') }}">Add Special Offers</a></li>
                                <li><a href="./ui-modal.html">View Products </a></li>
                                <li><a href="./ui-button-group.html">Update and Delete items</a></li>
                                <li><a href="./ui-list-group.html">Update Item Status (available/unavailable)</a></li>
                            </ul>
                        </li>
                        <li><a class="has-arrow ai-icon" href="javascript:void(0)" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                ...
                                <li><a href="index-2.html">Decline Order</a></li>
                                <li><a href="orders-list.html">Accept Manage Partial Order</a></li>
                                <li><a href="order-detail.html">Return Inventory </a></li>
                                <li><a href="customer-list.html">Replace Inventory </a></li>
                                <li><a href="analytics.html">Avail Promotion and offers</a></li>
                            </ul>
                        ...
                        <li><a class="has-arrow ai-icon" href="javascript:void(0)" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                <li><a href="./app-profile.html">Restaurant opening and closing </a></li>
                                <li><a href="./post-details.html">Restaurant availability and unavailability</a></li>
                            </ul>
                        </li>
                        ...
                        <li><a class="has-arrow ai-icon" href="javascript:void(0)" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                <li><a href="./uc-select2.html">Order Alerts </a></li>
                                <li><a href="./uc-nestable.html">View Orders</a></li>
                                <li><a href="./uc-noui-slider.html">Current Orders</a></li>
                                <li><a href="./uc-sweetalert.html">Accepted Orders </a></li>
                                <li><a href="./uc-toastr.html">Rejected Orders</a></li>
                                <li><a href="./map-jqvmap.html">Return Orders</a></li>
                                <li><a href="./uc-lightgallery.html">Generate Invoice</a></li>
                                <li><a href="./uc-lightgallery.html">Deliver Order</a></li>
                            </ul>
                        </li>
                        <li><a class="has-arrow ai-icon" href="javascript:void(0)" aria-expanded="false">
                                <i class="flaticon-072-printer"></i>
                                <span class="nav-text">Payment Collection </span>
                            </a>
                            <ul aria-expanded="false">
                                <li><a href="./form-element.html">Order Tracking</a></li>
                                <li><a href="./form-wizard.html">Track Payment history</a></li>
                                <li><a href="./form-editor-summernote.html">Customer support</a></li>
                            </ul>
                        </li>
                    </ul>
                    ...
                    <div class="copyright">
                        <p><strong>GallopEat  Admin  Dashboard</strong> © 2021 All Rights Reserved</p>
                        <p class="fs-12">Made with <span class="heart"></span> by Technosia</p>
                    </div>
                </div>
            </div>
            <!--**********************************
        ...
        ***********************************-->
        <div class="footer">
            ...
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="#" target="_blank">Technosia</a> 2021</p>
            </div>
        </div>
        <!--**********************************
            Footer end
...
<!-- Muhammad Salam Script Start -->
    	<!-- Datatable -->
    <script src="{{asset('vendor/datatables/js/jquery.dataTables.min.js')}}"></script>
    <script src="{{asset('js/plugins-init/datatables.init.js')}}"></script>
	    <!-- Toaster -->
	<script src="http://gallopeat.com/js/plugin/toastr.min.js"></script>
	<!-- Validate -->
    <script src="http://gallopeat.com/vendor/jquery-validation/jquery.validate.min.js"></script>
	<script>
		@if(Session::has('toast_msg'))
			var type = "{{ Session::get('toast_type') }}";
			switch(type){
				case 'info':
					toastr.info("{{ Session::get('toast_msg') }}");
					break;

				case 'warning':
					toastr.warning("{{ Session::get('toast_msg') }}");
					break;
				...
				case 'error':
					toastr.error("{{ Session::get('toast_msg') }}");
					break;
			}
		@endif
	</script>
	<!-- Muhammad Salam Script End -->
	@yield("extra_scripts")
